...
4. Si todo salío bien deberían estar en la pantalla principal de Visual Studio, en la parte superior deberán poder ver las configuraciones de compilación, por defecto están en *Release - x64*, lo deberán cambiar a *Debug - Win32*.
5. Si no se desconfiguró nada deberían ser capaces de darle al botón de *play* donde dice *Local Windows Debugger*, las primeras veces se tardará un poquito en compilar, sean pacientes. El *template* viene precargado con tres controladores, por lo qué pueden probar su instalación corriendo el programa y haciendo *clic* en los botones del programa en el siguiente orden:
